...
abstract class Controller {
	...
	public function __construct($registry) {
		$this->registry = $registry;
				...
				if( $this->registry->get('config') && $this->rgetMFP( $this->registry->get('config')->get('mfilter_url_param')?$this->registry->get('config')->get('mfilter_url_param'):'mfp' ) && ! $this->registry->get('config')->get('mfp_path_was_verificed') && isset( $this->registry->get('request')->get['route'] ) ) {
