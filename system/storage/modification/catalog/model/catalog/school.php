...
$query = $this->db->query($sql);
	...
	public function getProductAttributes($product_id)
	{
		...
		// echo '<pre>' . print_r($product_attribute_group_query->rows,true) . '</pre>';
...
$query = $this->db->query($sql);
	...
	public function getProductImages($product_id, $start, $end)
	{
		if (isset($start) && isset($end)) {
			$sql = ("SELECT * FROM " . DB_PREFIX . "product_image WHERE product_id = '" . (int)$product_id . "' AND sort_order BETWEEN $start AND $end  ORDER BY sort_order ASC");
...
$query = $this->db->query($sql);
	...
	public function getProductFilters($product_id) {
		...
		$sql = ("SELECT * FROM " . DB_PREFIX . "product_filter WHERE product_id = '" . (int)$product_id . "'");
