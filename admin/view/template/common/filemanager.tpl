...
<script type="text/javascript">
	...
	$('#button-search').on('click', function(e) {
		var url = 'index.php?route=common/filemanager&token=<?= $token; ?>&directory=<?= $directory; ?>';
...
<script type="text/javascript">
	...
	$('#button-upload').on('click', function() {
		...
		timer = setInterval(function() {
			if ($('#form-upload input[name=\'file[]\']').val() != '') {
				...
				$.ajax({
					url: 'index.php?route=common/filemanager/upload&token=<?= $token; ?>&directory=<?= $directory; ?>',
					type: 'post',
					dataType: 'json',
	...
	$('#button-folder').on('shown.bs.popover', function() {
		$('#button-create').on('click', function() {
			$.ajax({
				url: 'index.php?route=common/filemanager/folder&token=<?= $token; ?>&directory=<?= $directory; ?>',
				type: 'post',
				dataType: 'json',
