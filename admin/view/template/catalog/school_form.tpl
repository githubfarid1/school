                        ...
                        <div class="tab-pane active" id="tab-general">
                            <div class="tab-content">
                                ...
                                <div class="form-group <?php echo $col['required'] == 2 ? 'required' : '';?>">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="<?=$col['colname'];?>" id="" class="form-control"
                                        placeholder="" aria-describedby="helpId" value="<?=$col['value'];?>">
                                    </div>
                                </div>
                                <?php } ?>
                                <?php if ($col['coltype'] == 'number') {?>
                                    <div class="form-group <?php echo $col['required'] == 2 ? 'required' : '';?>">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" name="<?=$col['colname'];?>" id="" class="form-control"
                                            placeholder="" aria-describedby="helpId" value="<?=$col['value'];?>">
                                        </div>
                                    </div>
                                    <?php } ?>
                                ...
                                <div class="form-group <?php echo $col['required'] == 2 ? 'required' : '';?>">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control summernote" name="<?=$col['colname'];?>" id=""
                                            rows="3"><?=$col['value'];?></textarea>
                                    </div>
                                </div>
                                <?php } ?>
                                        ...
                                        <div class="col-sm-10">
                                            <div class="row">
                                                <div class="col-sm-2">
                                                    ...
                                                    <input type="text" name="<?=$col['colname'];?>[name]" id="" class="form-control" placeholder="title" aria-describedby="helpId" value="<?=$col['photo_name'];?>">
                                                    <textarea class="form-control" name="<?=$col['colname'];?>[description]" id="" rows="3" placeholder="description"><?=$col['photo_description'];?></textarea>
                                                </div>
                                            </div>
                                        ...
                                        <?php
                                            ...
                                            <?php while ($start <= $end) { ?>
                                                <div class="col-sm-2" style="margin-bottom: 15px;">
                                                    <a href="" id="thumb-<?=$col['colname'];?><?=$start;?>" data-toggle="image" class="img-thumbnail"
                                                        style="justify-content: center; display: flex;"><img src="<?=$col['value'][$start]['thumb'];?>"
                                                            alt="" title=""
                                                            data-placeholder="<?php echo $placeholder; ?>" /></a><input
                                                        type="hidden" name="<?=$col['colname'];?>[<?=$start;?>][image]" value="<?=$col['value'][$start]['image'];?>"
                                                        id="input-<?=$col['colname'];?><?=$start;?>" />
                                                    <input type="text" name="<?=$col['colname'];?>[<?=$start;?>][name]" id="" class="form-control" placeholder="title"
                                                        aria-describedby="helpId" value="<?=$col['value'][$start]['name'];?>">
                                                    <textarea class="form-control" name="<?=$col['colname'];?>[<?=$start;?>][description]" id="" rows="3"
                                                        placeholder="description"><?=$col['value'][$start]['description'];?></textarea>
                                                </div>
